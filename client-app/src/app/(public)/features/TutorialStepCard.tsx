...
export default function TutorialStepCard({
  ...
  return (
    ...
    >
      ...
      {/* Title */}
      <h3 className="relative z-10 text-2xl font-semibold tracking-tight mb-3 text-white">
        {title}
      </h3>

      {/* Description */}
      <p className="relative z-10 text-muted-foreground leading-relaxed text-white">
        {description}
      </p>
      ...
      <div className="relative z-10 mt-8">
        ...
        <p className="text-xs text-white mt-3 tracking-wide ">
